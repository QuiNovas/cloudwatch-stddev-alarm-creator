...
lambda_name = 'cloudwatch-stdev-alert-calculator'
...
lambda_description = 'Retrieves metrics from Cloudwatch, calculates standard deviation, and sets upper and/or lower alerts based on same'
